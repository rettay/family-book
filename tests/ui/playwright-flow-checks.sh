...
"${PWCLI}" run-code "async page => { await page.locator('#edit-contact-phone').waitFor(); await page.locator('#edit-is-living').uncheck(); await page.waitForFunction(() => document.getElementById('memorial-section')?.hidden === false); }"
