...
- [x] Trust docs distinguish field-level encryption, authenticated media, backups, and transport security.
- [x] No public copy claims zero-knowledge or end-to-end encryption unless implemented.
- [x] Export/delete/cancel paths are understandable.
- [x] Backup and restore guarantees match implementation.
- [x] Landing/README copy aligns with `FB-113` permission behavior.
...
- [x] Trust copy is launch-safe for paid beta.
