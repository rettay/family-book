...
Sprint goal:
- Replace the current product ambiguity with a truthful collaborative launch contract and a first build sequence focused on shared family workflows.
...
| ID | Title | Priority | Status | Task Packet |
|---|---|---:|---|---|
| FB-005 | Tree Preferences, Filters, and Map Foundation | P2 | todo | `task_packets/FB-005_tree_preferences_filters_and_map_foundation.md` |
