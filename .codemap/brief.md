...
**Modules:** 162  
**Languages:** python (87), unknown (71), javascript (4)  
**With AI briefings:** 0/162

## Architecture Overview

**Hub modules** (imported by others): `app/models/person.py` (27), `app/config.py` (19), `app/database.py` (16), `app/models/base.py` (14), `app/models/media.py` (10), `app/models/moments.py` (10), `app/models/relationships.py` (10), `app/auth.py` (9), `app/access_control.py` (8), `app/schemas.py` (7)
...
**domain-0** (69 modules): `app/models/person.py`, `app/config.py`, `app/database.py`, `app/models/base.py`, `app/models/media.py`, `app/models/moments.py`, `app/models/relationships.py`, `app/auth.py`
  ... and 61 more

## Architecture Roles

- **Core**: `app/models/person.py`, `app/config.py`, `app/models/base.py`, `app/access_control.py`, `app/schemas.py` (+1 more)
- **Utility**: `app/database.py`, `app/models/media.py`, `app/models/moments.py`, `app/models/relationships.py`, `app/auth.py` (+133 more)
- **Test Support**: `tests/conftest.py`, `tests/test_security_guardrails.py`, `tests/__init__.py`, `tests/test_access_control.py`, `tests/test_api.py` (+13 more)

## Top Modules Requiring Review

| Module | Score | Centrality | Top Factor |
|---|---:|---:|---|
| `app/access_control.py` | 0.61 | 0.75 | centrality (8 importers) |
| `app/backup/service.py` | 0.60 | 0.11 | churn (4 changes) |
| `app/services/media_service.py` | 0.58 | 0.06 | churn (4 changes) |
| `app/inbound/routes.py` | 0.50 | 0.03 | churn (3 changes) |
| `app/static/js/map.js` | 0.49 | 0.00 | churn (3 changes) |
| `app/services/moment_service.py` | 0.48 | 0.09 | churn (3 changes) |
| `app/schemas.py` | 0.47 | 1.00 | centrality (7 importers) |
| `app/routes/tree.py` | 0.47 | 0.00 | churn (7 changes) |
| `app/i18n.py` | 0.46 | 0.09 | centrality (3 importers) |
| `app/static/js/tree.js` | 0.45 | 0.00 | churn (8 changes) |

## Module Briefs

### app/models/person.py [hotspot] [testability: 1.00] [attention: 0.35] [domain-0] [unobservable]

**Radar:** U=0.9 C=0.6 E=1.0 S=1.0 T=0.3  
...
**Radar:** U=0.5 C=0.7 E=1.0 S=0.9 T=0.3  
...
### app/database.py [testability: 1.00] [attention: 0.20] [domain-0] [database]

**Radar:** U=1.0 C=0.8 E=1.0 S=1.0 T=0.5  
...
### app/models/base.py [testability: 1.00] [attention: 0.19] [CRITICAL] [domain-0] [unobservable]
...
### app/models/media.py [testability: 1.00] [attention: 0.16] [domain-0]
...
### app/models/moments.py [hotspot] [testability: 1.00] [attention: 0.19] [domain-0]

**Radar:** U=0.9 C=0.8 E=1.0 S=1.0 T=0.3  
...
### app/models/relationships.py [testability: 1.00] [attention: 0.05] [domain-0]

**Radar:** U=0.9 C=0.8 E=1.0 S=1.0 T=0.7  
...
### app/auth.py [testability: 0.70] [attention: 0.30] [domain-0]

**Radar:** U=1.0 C=0.6 E=0.5 S=1.0 T=0.5  
...
### app/access_control.py [hotspot] [testability: 0.40] [attention: 0.61] [CRITICAL] [domain-0] [observable]

**Radar:** U=0.4 C=0.3 E=0.5 S=0.8 T=0.6  
**Language:** python | **Complexity:** red (cyclomatic 53, 311 lines)
...
### app/schemas.py [hotspot] [testability: 0.55] [attention: 0.47] [CRITICAL] [domain-0] [unobservable]

**Radar:** U=0.6 C=0.3 E=0.5 S=0.8 T=0.6  
**Language:** python | **Complexity:** yellow (cyclomatic 12, 275 lines)
...
### app/services/field_protection.py [hotspot] [testability: 0.85] [attention: 0.13] [domain-0] [unobservable]

**Radar:** U=0.7 C=0.9 E=1.0 S=1.0 T=0.5  
...
### app/services/auth_service.py [hotspot] [testability: 0.85] [attention: 0.26] [domain-0]
...
### app/services/theme_service.py [hotspot] [testability: 0.85] [attention: 0.23] [domain-0]
...
### app/models/auth.py [testability: 1.00] [attention: 0.11] [domain-0]
...
### app/services/io_limits.py [hotspot] [filesystem] [testability: 0.65] [attention: 0.18] [domain-0]

**Radar:** U=0.6 C=0.9 E=1.0 S=0.9 T=0.5  
...
### app/models/revisions.py [testability: 1.00] [attention: 0.00] [domain-0]
...
### app/services/audit_service.py [testability: 0.70] [attention: 0.26] [domain-0]
...
### app/services/revision_service.py [testability: 1.00] [attention: 0.11] [domain-0] [observable]

**Radar:** U=0.9 C=0.9 E=1.0 S=1.0 T=0.6  
...
### app/backup/service.py [hotspot] [filesystem] [testability: 0.20] [attention: 0.60] [domain-0] [observable]

**Radar:** U=0.2 C=0.7 E=0.5 S=0.9 T=0.4  
...
### app/i18n.py [hotspot] [filesystem] [testability: 0.35] [attention: 0.46] [domain-0] [observable]

**Radar:** U=0.6 C=0.7 E=0.5 S=0.9 T=0.4  
...
### app/models/__init__.py [hotspot] [testability: 1.00] [attention: 0.17] [domain-0]

**Radar:** U=1.0 C=1.0 E=1.0 S=1.0 T=0.3  
...
### app/models/audit.py [testability: 0.70] [attention: 0.26] [domain-0]
...
### app/models/settings.py [testability: 1.00] [attention: 0.00] [domain-0]

**Radar:** U=1.0 C=0.7 E=1.0 S=1.0 T=0.3  
...
### app/middleware/security.py [hotspot] [testability: 0.70] [attention: 0.28] [domain-0] [observable]
...
### app/routes/auth_routes.py [hotspot] [testability: 0.70] [attention: 0.35] [domain-0] [observable] [endpoint]
...
### app/routes/media.py [hotspot] [testability: 0.70] [attention: 0.36] [domain-0] [observable] [endpoint]
...
### app/routes/moments.py [hotspot] [testability: 0.70] [attention: 0.36] [domain-0] [observable] [endpoint]
...
### app/routes/pages.py [hotspot] [testability: 0.70] [attention: 0.40] [domain-0] [observable] [endpoint]

**Radar:** U=0.3 C=0.9 E=1.0 S=1.0 T=0.4  
**Language:** python | **Complexity:** red (cyclomatic 85, 836 lines)
...
### app/routes/persons.py [hotspot] [testability: 0.70] [attention: 0.33] [domain-0] [observable] [endpoint]
...
### app/routes/relationships.py [hotspot] [testability: 0.40] [attention: 0.38] [domain-0] [observable] [endpoint]

**Radar:** U=0.4 C=0.6 E=0.5 S=1.0 T=0.7  
**Language:** python | **Complexity:** red (cyclomatic 24, 238 lines)
**Exports:** `_would_create_ancestry_cycle` (function), `_partnership_exists` (function)  
**Constructs:** 2 functions  

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/routes/tree.py [hotspot] [testability: 0.40] [attention: 0.47] [domain-0] [observable] [endpoint]

**Radar:** U=0.4 C=0.6 E=0.5 S=1.0 T=0.6  
**Language:** python | **Complexity:** red (cyclomatic 21, 285 lines)
**Exports:** `TreePreferencesPayload` (class), `MapMarkerPerson` (class), `MapMarker` (class), `MapResponse` (class), `_get_or_create_tree_preferences` (function), `_filtered_tree_people` (function), `_person_metric_maps` (function)  
**Constructs:** 3 functions, 4 classes  

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/services/moment_service.py [hotspot] [testability: 0.40] [attention: 0.48] [domain-0]
...
### app/services/google_auth.py [hotspot] [testability: 0.85] [attention: 0.09] [domain-0]
...
### app/services/protection_service.py [hotspot] [testability: 0.85] [attention: 0.20] [domain-0] [observable] [database]

**Radar:** U=0.6 C=1.0 E=1.0 S=1.0 T=0.4  
...
### app/models/preferences.py [testability: 0.70] [attention: 0.14] [domain-0]
...
### app/routes/health.py [hotspot] [testability: 1.00] [attention: 0.13] [domain-0] [observable] [endpoint]

**Radar:** U=1.0 C=1.0 E=1.0 S=1.0 T=0.4  
...
### app/routes/demo.py [hotspot] [testability: 0.40] [attention: 0.42] [domain-0] [endpoint]
...
### app/services/media_service.py [hotspot] [filesystem] [testability: 0.20] [attention: 0.58] [domain-0]
...
### app/matrix/client.py [hotspot] [testability: 0.55] [attention: 0.34] [domain-0] [observable]

**Radar:** U=0.6 C=0.7 E=0.5 S=1.0 T=0.4  
...
### app/matrix/handler.py [hotspot] [filesystem] [testability: 0.35] [attention: 0.42] [domain-0] [observable] [database]

**Radar:** U=0.5 C=0.7 E=0.5 S=0.9 T=0.4  
...
### app/services/bootstrap_service.py [hotspot] [testability: 0.55] [attention: 0.37] [domain-0] [observable] [database]
...
### app/backup/routes.py [hotspot] [testability: 0.70] [attention: 0.27] [domain-0] [observable] [endpoint]

**Radar:** U=0.9 C=0.7 E=0.5 S=1.0 T=0.4  
...
### app/matrix/startup.py [testability: 0.70] [attention: 0.24] [domain-0] [observable]

**Radar:** U=0.9 C=0.7 E=0.5 S=1.0 T=0.6  
...
### app/services/geo.py [testability: 0.70] [attention: 0.13] [domain-0]
...
### app/static/js/main.js [hotspot] [network] [testability: 0.20] [attention: 0.43] [service]

**Radar:** U=0.3 C=0.7 E=0.5 S=0.9 T=0.6  
**Language:** javascript | **Complexity:** red (cyclomatic 85, 346 lines)
**Constructs:** 14 functions  

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/static/js/map.js [hotspot] [network] [testability: 0.20] [attention: 0.49] [service]

**Radar:** U=0.2 C=0.7 E=0.5 S=0.9 T=0.3  
**Language:** javascript | **Complexity:** red (cyclomatic 22, 169 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/static/js/tree.js [hotspot] [network] [testability: 0.20] [attention: 0.45] [service]

**Radar:** U=0.2 C=0.7 E=0.5 S=0.9 T=0.4  
**Language:** javascript | **Complexity:** red (cyclomatic 80, 683 lines)
...
### app/static/css/main.css [testability: 0.70] [attention: 0.16]

**Radar:** U=0.8 C=0.7 E=0.5 S=1.0 T=0.6  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 1490 lines)
...
### app/templates/admin.html [hotspot] [testability: 0.70] [attention: 0.25]

**Radar:** U=0.8 C=0.7 E=0.5 S=1.0 T=0.4  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 312 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/templates/base.html [testability: 0.70] [attention: 0.16]
...
### app/templates/home.html [hotspot] [testability: 0.70] [attention: 0.25]

**Radar:** U=0.8 C=0.7 E=0.5 S=1.0 T=0.4  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 365 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/templates/invite.html [testability: 0.70] [attention: 0.10]
...
### app/templates/landing.html [testability: 0.70] [attention: 0.23]
...
### app/templates/login.html [testability: 0.70] [attention: 0.16]
...
### app/templates/map.html [testability: 0.70] [attention: 0.22]
...
### app/templates/partials/comments.html [testability: 0.70] [attention: 0.22]

**Radar:** U=1.0 C=0.7 E=0.5 S=1.0 T=0.5  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 20 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/templates/partials/media_gallery.html [testability: 0.70] [attention: 0.23]
...
**Radar:** U=0.9 C=0.7 E=0.5 S=1.0 T=0.5  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 179 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/templates/partials/people_grid.html [testability: 0.70] [attention: 0.21]
...
### app/templates/partials/person_history.html [testability: 0.70] [attention: 0.12]
...
### app/templates/partials/person_sidebar.html [testability: 0.70] [attention: 0.13]
...
### app/templates/people.html [testability: 0.70] [attention: 0.18]

**Radar:** U=1.0 C=0.7 E=0.5 S=1.0 T=0.6  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 39 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/templates/person.html [testability: 0.70] [attention: 0.19]

**Radar:** U=0.9 C=0.7 E=0.5 S=1.0 T=0.6  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 331 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/templates/person_edit.html [testability: 0.70] [attention: 0.18]

**Radar:** U=0.8 C=0.7 E=0.5 S=1.0 T=0.6  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 254 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/templates/person_new.html [hotspot] [testability: 0.70] [attention: 0.21]

**Radar:** U=0.9 C=0.7 E=0.5 S=1.0 T=0.4  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 148 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/templates/settings.html [testability: 0.70] [attention: 0.13]

**Radar:** U=0.9 C=0.7 E=0.5 S=1.0 T=0.7  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 70 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### app/templates/tree.html [testability: 0.70] [attention: 0.16]

**Radar:** U=0.9 C=0.7 E=0.5 S=1.0 T=0.7  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 185 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### locales/en.json [hotspot] [testability: 0.70] [attention: 0.21]

**Radar:** U=0.9 C=0.7 E=0.5 S=1.0 T=0.5  
**Language:** unknown | **Complexity:** green (cyclomatic 1, 181 lines)

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### locales/es.json [hotspot] [testability: 0.70] [attention: 0.21]
...
### locales/ru.json [hotspot] [testability: 0.70] [attention: 0.21]
...
**Language:** python | **Complexity:** green (cyclomatic 1, 756 lines)
...
**Language:** python | **Complexity:** green (cyclomatic 5, 507 lines)
**Exports:** `TestMomentsCRUD` (class), `TestMomentsFeed` (class), `TestMomentsPermissions` (class)  
**Constructs:** 3 classes  

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### tests/test_pages.py [hotspot] [domain-0]

**Language:** python | **Complexity:** green (cyclomatic 1, 112 lines)
**Exports:** `test_pages_router_exports_routes` (function), `test_pages_helper_functions_cover_locale_and_flags` (function)  
**Constructs:** 2 functions  

> *(no AI briefing — run `codemap analyze --ai` to generate)*

### tests/test_phase1_edge_cases.py [domain-0] [service]
...
*Generated by CodeMap on 2026-03-24 21:26 UTC. Estimated tokens: ~0 (0 words × 1.3). ACE ratio: N/A.*
